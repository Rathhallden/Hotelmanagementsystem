...
public class Regex {
    ...
    public static boolean negative(String input) {
        String rg = "\\W\\d{1,100}"; //set regex can input symbol then number
        Pattern pattern = Pattern.compile(rg);
        Matcher matcher = pattern.matcher(input);
        boolean check = matcher.matches();
        return check;
    ...
    public static boolean onlychar(String input) { //set regex only char
        String rg = "[a-z A-z]{1,1}";
        Pattern pattern = Pattern.compile(rg);
        Matcher matcher = pattern.matcher(input);
        boolean check = matcher.matches();
        return check;
